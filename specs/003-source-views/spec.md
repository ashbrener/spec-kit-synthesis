...
- **An engineer** in the BLOK9 portal opens the `docs` page, clicks a chip on an architecture
...
- **SC-001**: From a generated storybook, clicking a citation chip opens the cited source
  section rendered as HTML — verified on the BLOK9 docs portal (22 ADRs + specs reachable).
